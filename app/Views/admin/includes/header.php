...
<body>
    <div class="container-fluid position-relative d-flex p-0">
            ...
            <nav class="navbar bg-dark navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="<?= base_url('admin') ?>" class="dropdown-item">Sign In</a>
                            <a href="<?= base_url('list') ?>" class="dropdown-item">ADD Product</a>
        ...
        <div class="content">
            <!-- Navbar Start -->
            <nav class="navbar navbar-expand navbar-secondary bg-secondary sticky-top px-4 py-0" style="color">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg- border-0 rounded-0 rounded-bottom m-0">
