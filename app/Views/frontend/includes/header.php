...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= base_url() ?>/public/frontend/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <link href="<?= base_url() ?>/public/frontend/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">G2R</h1></a>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="<?= base_url('productdetails')?>" class="nav-item nav-link">Shop Detail</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a href="<?= base_url('cart')?>" class="dropdown-item">Cart</a>
                                    <a href="<?= base_url('checkout')?>" class="dropdown-item">Chackout</a>
